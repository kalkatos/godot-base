...
- Genre: [Insert genre here, e.g. action-adventure, puzzle, RPG, etc.]
- Perspective: [Insert perspective here, e.g. first-person, top-down, isometric, etc.]
- Player count: [Insert player count here, e.g. single-player, local co-op, online multiplayer, etc.]
- Target platform: [Insert target platform here, e.g. PC, console, mobile, etc.]
